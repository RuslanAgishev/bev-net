...
class SegmentationDataMap(NuscData):
    ...
    def __getitem__(self, index):
        ...
        road_binimg = self.get_local_map_torch(rec)
        map_binimg = torch.cat([road_binimg, cars_binimg], dim=0)

        return imgs, rots, trans, intrins, post_rots, post_trans, map_binimg

    def get_local_map_torch(self, rec):
        ...
        lmap_poly = get_local_map_poly(self.nusc_maps[map_name], center, 50.0, poly_names, line_names)
